	...
	public function infoItem($arrParam,$option = null){
		if ($option==null) {
			...
			if ($result['group_acp']==1) {
				...
				$strPrivilegeID  = '';
				foreach ($arrPrivilege as $privilegeID)  $strPrivilegeID .="'$privilegeID',"; $strPrivilegeID .="0";
				
				$queryP[] = "SELECT id , CONCAT(module,'-' ,controller,'-',action)  name";
				$queryP[] ="FROM ".TBL_PRIVELEGE." AS p";
				$queryP[] = "WHERE id IN ($strPrivilegeID)";
